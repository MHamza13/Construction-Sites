...
const AppSidebar: React.FC = () => {
  const { isExpanded, isMobileOpen, isHovered, setIsHovered, totalUnreadCount } =
    useSidebar();
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Pending Review", path: "/PendingReview" },
        { name: "Project Expence", path: "/project-expence" },
      ],
    },
    // {
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "ImportantTypes", path: "/important-types" },
            ...
            nav.path && (
              ...
              >
                ...
                {(isExpanded || isHovered || isMobileOpen) && (
                  <>
                    <span className={`menu-item-text`}>{nav.name}</span>
                    {nav.name === "Chat" && totalUnreadCount > 0 && (
                      <span
